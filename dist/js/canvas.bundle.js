...
function animate() {
  ...
  player.update();
  if (keys.right.pressed && player.position.x < 400) player.velocity.x = player.speed;else if (keys.left.pressed && player.position.x > 100 || keys.left.pressed && scrollOfSet === 0 && player.position.x > 0) {
...
function Omar() {
  smalltallplatform = CreateImage(_img_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_3__["default"]);
  platformImage = CreateImage(_img_platform_png__WEBPACK_IMPORTED_MODULE_0__["default"]);
  player = new Player();
  platforms = [new Platform({
    x: platformImage.width * 4 + 300 - 2 + platformImage.width - smalltallplatform.width,
    y: 270,
...
var smalltallplatform = CreateImage(_img_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_3__["default"]);
